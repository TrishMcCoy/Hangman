...
var alphabet = 'abcdefghijklmnopqrstuvwxyz'.split(''),
		...
		remainingBlanks = 0,
		puzzleList = [
	"algea", "blowfish", "clownfish", "conch", "flounder", "hammerhead", "jellyfish", "lobster", "ocean", "pufferfish", "segaull", "starfish", "sealion", "whale", "shipwreck", "snorkeling", "stingray", "seaweed"],
		hangmanParts = [
